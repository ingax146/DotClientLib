...
import se.inax.dot.client.directed.DirectedGraphGenerator;
import se.inax.dot.client.render.GraphFooterRenderer;
import se.inax.dot.client.render.NodeDefinitionRenderer;
import se.inax.dot.client.undirected.UndirectedGraphGenerator;
 ...
 *
 */
public abstract class DotClient {

	/**
	 *
	 * @return a facade used for generating directed graphs.
	 */
	public static DotClient directedGraphGenerator() {
	 ...
	 */
	public static DotClient undirectedGraphGenerator() {
